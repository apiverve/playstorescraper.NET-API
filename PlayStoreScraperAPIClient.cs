...
namespace APIVerve
{
    public class PlayStoreScraperAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/playstorescraper";
        ...
        public PlayStoreScraperAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public PlayStoreScraperAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(playstorescraperQueryOptions options)
        {
            try
            {
                if (_isDebug)
